...
var user_configuration={
	...
	final_size:"68px", //final size of the stars after expansion
	expand_speed:"2.5s", //how fast the stars get bigger, in milliseconds
	fade_delay:"1s", //how long until the star fades out
	fade_duration:"1.2s", //how long the star fades for
	colors:["hsla(62, 50%,50%, 0.5)", "rgba(253,110,112,0.5)","hsla(180, 72%, 52%, 0.5)"], //The variety of colors of the stars. Can be any CSS complient color (eg. HEX, rgba, hsl)
	frequency:350, //how often a new wave of stars pop-out (in milliseconds. Bigger==longer)
	...
	coverage:.7, //how much of the element's area the stars will show up in (0-1)
